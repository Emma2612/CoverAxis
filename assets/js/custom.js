...
function slick_client(e) {
  ...
  t.length > 0 &&
    ...
    e.width() > 991 &&
      (dsnGrid.parallaxMoveElemnt(t.find(".fas.fa-angle-right"), 25),
      dsnGrid.parallaxMoveElemnt(t.find(".fas.fa-angle-left"), 25)));
}
...
!(function (e) {
    ...
    data_overlay(),
      (function () {
        if (e('[data-dsn-temp="light"]').length > 0) {
          ...
          t.length <= 0
            ? o.addClass("menu-light")
            : t.hasClass("header-hero-2") && o.addClass("menu-light");
        ...
        return {
          ...
          ajaxSlider: function (t, n) {
            let a = this,
              ...
              o = e(
                '.dsn-slider .slide-item[data-dsn-id="' + i + '"] .cover-bg'
              ).first(),
              s = n;
            void 0 !== s &&
              TweenMax.to(
                ...
                0.8,
                {
                  ...
                  onComplete: function () {
                    o.removeClass("hidden"),
                      ...
                      a.createElement(o, s, e(".dsn-root-slider"));
                  },
                }
              );
          },
          ...
          ajaxNextProject: function (e, t) {
            ...
            void 0 !== o &&
              ...
              TweenMax.staggerTo(
                a.find(".project-title").find("span , h5"),
                0.8,
                { autoAlpha: 0, y: -50 },
                0.1,
                function () {
          ...
          addElement: function (e, t, n) {
            ...
            return (
              ...
              a.css(dsnGrid.getBoundingClientRect(n[0])),
              e.append(a),
              a
            );
          },
            ...
            a.length <= 0
              ...
              : (TweenMax.set(a, { autoAlpha: 1, zIndex: 99999999 }),
                TweenMax.to(a, 1, {
                  ...
                  ease: Expo.easeInOut,
                  onComplete: function () {
                    e('[data-dsn-header="blog"]').css("width", "100%"),
                      i.createElement(a, n);
                  },
                }));
          },
      ...
      e(".client-see .slick-slider  ").slick({
        infinite: !0,
        slidesToShow: 1,
        arrows: !1,
        dots: !0,
      ...
      (function () {
        ...
        n.each(function (t) {
          ...
          let i = n.find("img");
          i.attr("data-dsn-id", t),
            n.hasClass("dsn-active") && i.addClass("dsn-active"),
            a.append(i);
        }),
          n.on("mouseenter", function () {
            ...
            if (t.hasClass("dsn-active") || o.hasClass("dsn-ajax-effect"))
              return;
            ...
            a
              ...
              .removeClass("dsn-active-enter")
              .removeClass("dsn-active-leve"),
              i.addClass("dsn-active-leve"),
              t.addClass("dsn-active dsn-active-enter");
          });
      })(),
      (function () {
        ...
        return {
          initSlider: function () {
            ...
            n.each(function (t) {
              ...
              n.attr("data-dsn-id", t),
                0 === t && n.addClass("dsn-active dsn-active-cat"),
                a.append(n);
            ...
            e.on("progress", function () {
              ...
              for (let t = 0; t < e.slides.length; t++) {
                let n = e.slides[t].progress,
                  a = 0.5 * e.width,
                  i = n * a;
                e.slides[t].querySelector(".image-bg").style.transform =
                  "translateX(" + i + "px) ";
              }
            });
          },
          slideChange: function (a) {
            ...
            a.on("slideChange", function () {
              ...
              let l = e(this.slides[this.activeIndex]).find(
              ...
              let c = t.find('.dsn-slider-content [data-dsn-id="' + r + '"]'),
                ...
                h = new TimelineLite();
              h.staggerFromTo(
                dsnGrid.randomObjectArray(d, 0.3),
                0.3,
                i.showText().title,
                i.hideText(f).title,
                0.1,
          ...
          hideText: function (e) {
            ...
            return (
              e && (t = "90%"),
              {
                ...
                subtitle: { autoAlpha: 0, y: t, ease: Elastic.easeOut },
              }
            );
          },
            ...
            e.on("setTransition", function (e) {
              ...
              for (let n = 0; n < t.slides.length; n++)
                (t.slides[n].style.transition = e + "ms"),
                  (t.slides[n].querySelector(".image-bg").style.transition =
                    e + "ms");
            });
          },
            ...
            return new Swiper(".dsn-slider .slide-inner", {
              ...
              on: {
                ...
                imagesReady: function () {
                  let t = e(this.slides[this.activeIndex]).find(
                    '[data-dsn="video"] video'
                  );
                  t.length > 0 && t[0].play();
                },
    ...
    void 0 !== o ? (a = o) : a.top <= 70 && (a = s),
      r.getListener(function (e) {
        ...
        void 0 !== a && (o = a.top - 100),
          n > o
            ? l < n
              ? t.addClass("nav-bg").addClass("hide-nave")
              : t.removeClass("hide-nave")
  ...
  function a() {
    ...
    return {
      ...
      isScroller: function (e) {
        ...
        let t =
          !o.hasClass("dsn-effect-scroll") || this.isMobile() || null === a;
      ...
      unlocked: function () {
        o.removeClass("locked-scroll"),
          this.start(),
          n(),
          l.allInt(),
          dsnGrid.progressCircle(r);
      },
      ...
      start: function () {
        if (
          ...
          e(".scroll-down").on("click", function (t) {
            t.preventDefault();
            let n = i;
            r.isScroller(!0) && (n = r.getScrollbar()),
              TweenLite.to(n, 1.5, {
          ...
          e(".scroll-down-nav").on("click", function (t) {
            ...
            if (id != null && id != undefined && e(id) != undefined) {
              r.isScroller(!0) && (n = r.getScrollbar()),
                TweenLite.to(n, 1.5, {
  ...
  const i = e(window),
    ...
    s = {
      animateTextAjax:
        '.headefr-fexid .project-title .title-text-header .cat ,[data-dsn-animate="ajax"] , footer, .next-project , .root-project',
    };
  (navigator.userAgent.match(/Edge/i) ||
    navigator.userAgent.match(/MSIE 10/i) ||
    navigator.userAgent.match(/MSIE 9/i)) &&
    e(".cursor").css("display", "none"),
    (function () {
      var t = e(".preloader"),
    ...
    // function to close menu upon clicking on anchor tag
    (function () {
      var t = e(".menu-icon");
        ...
        i.on("load", function () {
          ...
          void 0 !== i && i.prepend(a),
            ...
            e(".nav__list-dropdown > a").on("click", function (t) {
              ...
              e(".nav__list-dropdown").find("ul").slideUp("slow"),
                "block" !== a && n.find("ul").slideDown("slow");
            });
        }),
      ...
      if (!(n.length <= 0)) {
        var a = n.find(".text-button"),
          s = n.find(".text-open"),
          r = n.find(".text-close");
        dsnGrid.convertTextWord(a, a, !0),
          dsnGrid.convertTextWord(s, s, !0),
          dsnGrid.convertTextWord(r, r, !0);
      }
    })();
  var r = a(),
    l = (function () {
      ...
      return {
        ...
        headerProject: function () {
          ...
          let a = e("#dsn-hero-parallax-img"),
            ...
            r = e("#descover-holder"),
            l = 1.2;
          a.hasClass("parallax-move-element") &&
            dsnGrid.parallaxMoveElemnt(
              { target: e(n), element: a.find(".cover-bg") },
              5,
              1
            );
          ...
          if (
            (i.length > 0 &&
              (i.hasClass("project-title") && (l = 1),
              d.to(
                i,
                0.8,
                { force3D: !0, top: "30%", autoAlpha: 0, scale: l },
                0
              )),
            s.length > 0 &&
              d
                .to(s, 1, { force3D: !0, height: 80 }, 0)
                .to(
                ...
                .to(
                  i.find(".slider-header.slider-header-top"),
                  1,
                  { force3D: !0, height: 0 },
                  0
                ),
            r.length > 0 &&
              d.to(r, 0.8, { force3D: !0, bottom: "-10%", autoAlpha: 0 }, 0),
            d._totalDuration <= 0)
          )
            return !1;
          ...
          return (
            (u.length > 0 || o.hasClass("v-light")) &&
              (c.on("enter", function () {
                u.length > 0 && u.get(0).play(),
                  o.hasClass("v-light") &&
                    !e(n).hasClass("header-hero-2") &&
                    o.removeClass("menu-light");
              }),
              c.on("leave", function () {
                u.length > 0 && u.get(0).pause(),
                  o.hasClass("v-light") &&
                    !e(n).hasClass("header-hero-2") &&
                    o.addClass("menu-light");
              })),
          ...
          let n = e("#dsn-next-parallax-img"),
            ...
            s =
              ...
              new ScrollMagic.Scene({
                ...
                .setTween(
                  TweenMax.to(n, 1, { force3D: !0, y: "30%", scale: 1 }, 0)
                )
                .addTo(t),
            l =
              !(i.length <= 0) &&
          ...
          e('[data-dsn-grid="move-up"]').each(function () {
            ...
            if (a.length > 0) {
              ...
              if (a.hasClass("has-top-bottom")) {
                ...
                1 !== i
                  ? (a.css("top", 0),
                    (s = TweenMax.to(a, 2, { force3D: !0, scale: t, y: e })))
                  : (s = TweenMax.to(a, 1, {
                      force3D: !0,
                      scale: t,
                      y: e,
        ...
        moveSection: function () {
          e('[data-dsn-grid="move-section"]').each(function () {
            ...
            let a = dsnGrid.getUndefinedVal(n.data("dsn-move"), -100),
              ...
              s = dsnGrid.getUndefinedVal(
                n.data("dsn-opacity"),
                n.css("opacity")
              ),
              l = dsnGrid.getUndefinedVal(n.data("dsn-duration"), "150%");
            if ("tablet" === n.data("dsn-responsive") && i.width() < 992)
              return;
        ...
        parallaxImgHover: function () {
          ...
          0 === t.length ||
            ...
            t.each(function () {
              var t = e(this),
                n =
                  (dsnGrid.removeAttr(t, "data-dsn"),
                  dsnGrid.removeAttr(t, "data-dsn-speed")),
                a = dsnGrid.removeAttr(t, "data-dsn-move"),
                i = !1;
              t.hasClass("image-zoom") && (i = !0),
                dsnGrid.parallaxMoveElemnt(t, a, n, void 0, i);
            });
        },
        changeColor: function () {
          ...
          e('[data-dsn="color"]').each(function () {
            let i = dsnGrid.getUndefinedVal(
              e(this).data("dsn-duration"),
              e(this).outerHeight() + 70
            );
        ...
        animateText: function () {
          e('[data-dsn-animate="text"] , [data-dsn-animate="up"]').each(
            function () {
              let n = e(this),
                a = 1;
              "text" === n.data("dsn-animate")
                ? (dsnGrid.convertTextWord(n, n),
                  n.attr("data-dsn-animate", "animate"))
                : (a = 0.8);
        ...
        headerBlog: function () {
          ...
          if (!(n.length <= 0 || i.width() < 992)) {
            var a = new ScrollMagic.Scene({
              ...
              .setTween(
                TweenMax.fromTo(n, 1, { width: "100%" }, { width: "80%" })
              )
              .addTo(t);
            r.getListener(function () {
              a.refresh();
